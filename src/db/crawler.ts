...
export async function saveFinding(shop: string | null, runId: number | null, benchmarkId: number | null, f: Finding): Promise<void> {
  await pgQuery(
    `insert into findings
       (shop_domain, run_id, benchmark_id, kind, intent, prompt_text, engine, merchant_brand, winning_competitor,
    ...
    [
      shop, runId, benchmarkId, f.kind, f.intent, f.promptText, f.engine, f.merchantBrand, f.winningCompetitor,
