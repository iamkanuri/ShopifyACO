...
export const DEMO = {
  ...
  billing: <AppBilling>{
    ...
    plans: [
      { id: "free_mini", name: "Free mini scan", price: "$0", cadence: "", blurb: "See if AI assistants know you.", features: ["5 buyer-intent prompts", "3 engines", "Readiness measure + competitor leaderboard"], limits: { benchmarksPerMonth: 3, monitoringSchedules: 0, feeds: 1 }, tier: 0, stripeUrl: null, current: true },
