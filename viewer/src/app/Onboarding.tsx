...
export function Onboarding() {
  const steps = [
    { n: 1, t: "Connect your store", d: "Install AisleLens from the Shopify App Store to connect your store and read your catalog.", connect: true, cta: "Get it on the Shopify App Store" },
