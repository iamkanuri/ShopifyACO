...
- **Olipop** was mentioned in **85%** of answers and explicitly **recommended in 58%**.
- That ranks **#1 of 5** by mention rate (brand + 4 competitors).
- Top competitor by recommendation rate: **Poppi** (15% recommended, 79% mentioned).
...
| openai | gpt-5.4-mini | ✅ web_grounded | 16 | 0 |

## Share of voice — mention rate vs recommendation rate

| Brand | Mention rate | Recommendation rate | Avg list rank |
|---|---|---|---|
| **Olipop** (you) | 85% (41/48) | 58% (28/48) | 2.0 |
| Poppi | 79% (38/48) | 15% (7/48) | 3.3 |
| Culture Pop | 27% (13/48) | 2% (1/48) | 5.3 |
| Health-Ade | 15% (7/48) | 2% (1/48) | 4.8 |
| Spindrift | 10% (5/48) | 0% (0/48) | 4.2 |
...
| Brand | Mention rate | Recommendation rate | Avg list rank |
|---|---|---|---|
| **Olipop** (you) | 100% (16/16) | 63% (10/16) | 2.0 |
| Poppi | 94% (15/16) | 31% (5/16) | 2.8 |
| Culture Pop | 19% (3/16) | 6% (1/16) | 4.5 |
| Health-Ade | 6% (1/16) | 6% (1/16) | — |
| Spindrift | 13% (2/16) | 0% (0/16) | 5.0 |

### gemini

| Brand | Mention rate | Recommendation rate | Avg list rank |
|---|---|---|---|
| **Olipop** (you) | 81% (13/16) | 63% (10/16) | 2.1 |
| Poppi | 81% (13/16) | 6% (1/16) | 3.7 |
| Culture Pop | 31% (5/16) | 0% (0/16) | 6.8 |
| Health-Ade | 38% (6/16) | 0% (0/16) | 4.8 |
| Spindrift | 13% (2/16) | 0% (0/16) | 4.5 |

### openai

| Brand | Mention rate | Recommendation rate | Avg list rank |
|---|---|---|---|
| **Olipop** (you) | 75% (12/16) | 50% (8/16) | 1.9 |
| Poppi | 63% (10/16) | 6% (1/16) | 3.0 |
| Culture Pop | 31% (5/16) | 0% (0/16) | 4.3 |
| Health-Ade | 0% (0/16) | 0% (0/16) | — |
| Spindrift | 6% (1/16) | 0% (0/16) | 2.0 |

## Per-prompt × engine results

| Prompt | Engine | Olipop | Competitors mentioned | Top competitor |
|---|---|---|---|---|
| What are the best prebiotic soda brands? | perplexity | recommended | 1 | Poppi (recommended) |
| What are the best prebiotic soda brands? | gemini | recommended #1 | 2 | Poppi (mentioned_neutral) |
| What are the best prebiotic soda brands? | openai | recommended #1 | 2 | Poppi (mentioned_neutral) |
| Recommend a prebiotic soda for cutting back on su… | openai | mentioned | 1 | Poppi (mentioned_neutral) |
| Recommend a prebiotic soda for cutting back on su… | perplexity | recommended #1 | 0 | — |
| Recommend a prebiotic soda for gut health. | openai | recommended #1 | 0 | — |
| Recommend a prebiotic soda for cutting back on su… | gemini | recommended #1 | 1 | Poppi (mentioned_neutral) |
| Recommend a prebiotic soda for gut health. | gemini | recommended #1 | 2 | Poppi (mentioned_neutral) |
| Recommend a prebiotic soda for gut health. | perplexity | mentioned | 1 | Poppi (mentioned_neutral) |
| Recommend a prebiotic soda for a healthier soda c… | openai | recommended #2 | 0 | — |
| Recommend a prebiotic soda for a healthier soda c… | perplexity | mentioned | 1 | Poppi (mentioned_neutral) |
| Recommend a prebiotic soda for a healthier soda c… | gemini | recommended #1 | 1 | Poppi (mentioned_neutral) |
| I'm someone trying to cut back on regular soda. W… | gemini | recommended #1 | 2 | Poppi (mentioned_neutral) |
| I'm someone trying to cut back on regular soda. W… | perplexity | recommended #3 | 1 | Poppi (mentioned_neutral) |
| Best-tasting prebiotic soda? | openai | recommended #1 | 0 | — |
| What's the healthiest soda I can drink? | openai | absent | 0 | — |
| I'm someone trying to cut back on regular soda. W… | openai | recommended #1 | 1 | Poppi (recommended) |
| Best-tasting prebiotic soda? | perplexity | recommended | 1 | Poppi (mentioned_neutral) |
| Best-tasting prebiotic soda? | gemini | recommended #1 | 2 | Poppi (mentioned_neutral) |
| Best soda alternatives for cutting back on sugar? | openai | absent | 0 | — |
| What's the healthiest soda I can drink? | perplexity | mentioned | 1 | Poppi (mentioned_neutral) |
| What's the healthiest soda I can drink? | gemini | absent | 0 | — |
| Best soda alternatives for gut health? | openai | absent | 0 | — |
| Best soda alternatives for cutting back on sugar? | gemini | absent | 1 | Spindrift (mentioned_neutral) |
| Best soda alternatives for cutting back on sugar? | perplexity | recommended #2 | 3 | Poppi (recommended) |
| Best soda alternatives for gut health? | gemini | absent | 1 | Health-Ade (mentioned_neutral) |
| Best soda alternatives for gut health? | perplexity | recommended | 3 | Poppi (recommended) |
| Best soda alternatives for a healthier soda cravi… | openai | mentioned | 3 | Poppi (mentioned_neutral) |
| Best soda alternatives for a healthier soda cravi… | gemini | mentioned | 2 | Poppi (mentioned_neutral) |
| Which prebiotic soda brand has the least sugar? | openai | absent | 2 | Poppi (mentioned_neutral) |
| Best soda alternatives for a healthier soda cravi… | perplexity | recommended #5 | 3 | Poppi (recommended) |
| Which prebiotic soda brand has the least sugar? | perplexity | mentioned | 1 | Poppi (mentioned_neutral) |
| Which prebiotic soda brand has the least sugar? | gemini | recommended #1 | 2 | Poppi (mentioned_neutral) |
| Which prebiotic soda brand has the most fiber? | openai | mentioned | 1 | Poppi (mentioned_neutral) |
| Which prebiotic soda brand has the best flavor? | perplexity | recommended #1 | 1 | Poppi (recommended) |
| Which prebiotic soda brand has the best flavor? | gemini | recommended #1 | 2 | Poppi (mentioned_neutral) |
| Which prebiotic soda brand has the best flavor? | openai | recommended #1 | 1 | Poppi (mentioned_neutral) |
| Which prebiotic soda brand has the most fiber? | perplexity | mentioned | 1 | Poppi (mentioned_neutral) |
| Which prebiotic soda brand has the most fiber? | gemini | mentioned | 2 | Poppi (mentioned_neutral) |
| Olipop vs Poppi — which should I buy? | openai | recommended #1 | 1 | Poppi (mentioned_neutral) |
| Olipop vs Poppi — which should I buy? | gemini | recommended #1 | 1 | Poppi (recommended) |
| What soda is actually good for gut health? | openai | mentioned | 2 | Poppi (mentioned_neutral) |
| Olipop vs Poppi — which should I buy? | perplexity | recommended #1 | 1 | Poppi (mentioned_neutral) |
| What soda is actually good for gut health? | perplexity | mentioned | 1 | Poppi (mentioned_neutral) |
| What soda is actually good for gut health? | gemini | mentioned | 2 | Poppi (mentioned_neutral) |
| Popular prebiotic soda people recommend right now? | openai | recommended #1 | 2 | Poppi (mentioned_neutral) |
...
|---|---|---|---|
| Best soda alternatives for cutting back on suga… | gemini | absent | Spindrift (mentioned_neutral) |
| Best soda alternatives for gut health? | gemini | absent | Health-Ade (mentioned_neutral) |
| Which prebiotic soda brand has the least sugar? | openai | absent | Poppi (mentioned_neutral) |

## Prompts where the brand is absent

- _openai_: What's the healthiest soda I can drink?
...
- _gemini_: Best soda alternatives for cutting back on sugar?
- _gemini_: Best soda alternatives for gut health?
- _openai_: Which prebiotic soda brand has the least sugar?
...
|---|---|---|---|
| perplexity | 618 | 6447 | $0.0071 |
| gemini | 617 | 6499 | $0.0164 |
| openai | 125006 | 6422 | $0.1227 |
| **Total** | **126241** | **19368** | **$0.1462** |
...
|---|---|---|---|
| Perplexity | 100% (16/16) | 63% (10/16) | 2.0 |
